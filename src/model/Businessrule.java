 ...
 */
	public ResultSet getInfo(String type)  {
		dao = null;
	 ...
	 */
	public void loadFromDbIntoObject() {
		...
		try {
			if(rs.next()){
				...
				this.setOperator(rs.getString("ANNOTATION"));
				rs.close();
			...
			logger.severe("Error handling resultset in class Businessrule");
		}
		dao.closeConnection();
